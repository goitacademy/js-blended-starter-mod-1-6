...
Додаємо в `--base=/<REPO>/` назву свого репозиторія. Назва репозиторію в
`--base` повинна повністю збігатися з назвою репозиторію на GitHub.
...
Стартовий шаблон містить готовий HTML і підключений файл `src/main.js`. Під час
заняття учасники змінюють лише `src/main.js`.
...
4. Після відправлення гілки на GitHub необхідно створити **Pull Request** та
   ...
   - праворуч — свою робочу гілку. Після цього натисніть кнопку
     `Create pull request`. ![pr 2](./assets/create-pr-2.png)

   За потреби змініть назву Pull Request або додайте його опис, після чого
   натисніть `Create pull request`. ![pr 3](./assets/create-pr-3.png)

   Натисніть кнопку `Merge pull request`. ![pr 4](./assets/create-pr-4.png)
